...
public static final String OUVRIR_FICHIER = "Ouvrir un fichier non cypt�";
public static final String OUVRIR_FICHIER_CRYPTE = "Ouvrir un fichier crypt�";
public static final String ENREGISTRERSOUS_CLEF = "Enregistrer la clef";
public static final String ENREGISTRERSOUS_FICHIER = "Enregistrer le fichier non crypt�";
public static final String ENREGISTRERSOUS_FICHIER_CRYPTE = "Enregistrer le fichier crypt�";
...
public static final String BOUTTON_VIGENERE = "Vigen�re";
public static final String BOUTTON_VIGENERE_AMELIORE = "Vigen�re am�lior�";
public static final String BOUTTON_CESAR_AMELIORE = "C�sar am�lior�";
public static final String BOUTTON_CESAR_CLASSIQUE = "C�sar classique";
public static final String BOUTTON_RSA = "RSA";
public static final String BOUTTON_LANCER_CRYPTAGE = "Lancer le cryptage";
public static final String BOUTTON_LANCER_DECRYPTAGE = "Lancer le d�cryptage";
public static final String CHERCHER_CLEF = "Chercher la clef de cryptage";
public static final String BOUTTON_LANCER_CREATION_CLEF = "Creer une clef al�atoire";
public String choixcryptage=BOUTTON_CESAR_AMELIORE; /* Le type de cryptage que l'utilisateur a s�l�ctionn� (par d�faut : AES) */
...
public JLabel supertitre2 = new JLabel("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre compos�e de 7 caract�res ASCII<br/> - Le message n'a pas de restriction particuli�re</html>");
...
Fenetre(String titre){
	...
	/* --------------------------------------------------- Definition de notre fen�tre de base ------------------------------- */
		super(titre);
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); /*permet de quitter l'application en m�me temps que la fen�tre*/
		/* Fen�tre compatible avec des �crans de tailles superieurs ou �gaux � 800x600 : */
		this.setLocation(0,0); /* O� se trouve la fen�tre par d�faut */
		this.setSize(1024,768); /* Taille de la fen�tre par d�faut */
	    this.setLayout(new BorderLayout());
	   this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource(LOGO_IMG)));  // Icone
	/* --------------------------------------------------- Fin de la definition de notre fen�tre de base --------------------- */
	/* --------------------------------------------------- LE MENU ------------------------------------------------------------*/
		/* Notre menu : */
			JMenuBar m= new JMenuBar(); /* Cr�ation du menu */

		/* Barre de menu "Fichier" */
			JMenu fichiers=new JMenu("Fichier");

			JMenuItem nouveau = new JMenuItem(NOUVEAU, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(NOUVEAU_IMG)))) ; /* Les �lements de Fichier */
			...
			fichiers.add(nouveau); /* Ajouter les �l�ments s�par�s au menu fichiers */
			...
			m.add(fichiers); /* Ajouter fichiers � la barre de menu */
		...
		/* Barre de menu "Edition" */
			...
			/*edition.add(annuler); // Ajouter les �l�ments s�par�s au menu edition
			...
			m.add(edition); // Ajouter �dition � la barre de menu



		/* Barre de menu "Cryptages sym�triques puis asym�triques" */

			JMenu cryptages=new JMenu("Type de cryptage");

			JMenuItem boutton_aes = new JMenuItem(BOUTTON_AES, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(CRYPTAGE_IMG)))) ; /* Les �lements de Cryptages */
			...
			//cryptages.add(boutton_aes); /* Ajouter les �l�ments s�par�s au menu cryptages */
			...
			m.add(cryptages); /* Ajouter �dition � la barre de menu */
		...
		/* Barre de menu "A Propos" */
			...
			JMenuItem aide = new JMenuItem(AIDE, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(AIDE_IMG)))) ; /* Les �lements de A Propos */
			...
			menuapropos.add(aide); /* Ajouter les �l�ments s�par�s au menu A Propos */
			menuapropos.addSeparator();
			menuapropos.add(apropos);

			m.add(menuapropos); /* Ajouter A Propos � la barre de menu */
	    ...
	    JLabel bouttonseparateur= new JLabel("Type de cryptage utilis� : ");
		...
		*/
	    ...
	    /* Paragraphe expliquant les modalit�s du cryptage en question */
	    ...
	    /* Bloc panelclef */
		   ...
		   // JTextField texte_clef = new JTextField("Clef de cryptage");
		    ...
		    texte_clef.setToolTipText("Cl� � utiliser pour l'op�ration de chiffrement/d�chiffrement");
	    ...
	    /* Bloc paneltxtdecrypte */
		    ...
		    texte_message_decrypte.setText("Message d�crypt�");
		   ...
		   // texte_message_decrypte.addMouseListener(this);
		    paneltxtdecrypte.add(new JLabel("Votre message d�crypt� : "));
	    ...
	    /* Bloc paneltxtcrypte */
		    ...
		    texte_message_crypte.setText("Message crypt�");
		    ...
		    paneltxtcrypte.add(new JLabel("Votre message crypt� :      "));
		...
		this.setVisible(true); /* Autoriser l'affichage de la fen�tre (� mettre � la fin de notre fonction */
	}
	...
	// FONCTION PAS TERMINE !!!! A FINIR !!!!!!!!!!!!!
		...
		public void gererPageCryptage(){
			if(choixcryptage==BOUTTON_RSA){
				// RSA est un cryptage asym�trique (--> 2 clefs, 1 String crypt�, 1 String d�crypt�)
				System.out.println("Ouverture d'une page pour le cryptage asym�trique.\nEn effet, le choix de cryptage est de type "+choixcryptage);
			}
			else
			{
				// Tout les autres cryptages sont de type cryptage sym�trique (--> 1 clef, 1 String crypt�, 1 String d�crypt�)
				System.out.println("Ouverture d'une page pour le cryptage sym�trique.\nEn effet, le choix de cryptage est de type "+choixcryptage);
...
// Les m�thodes des actions

	public void actionPerformed(ActionEvent e) {
		String cmd = e.getActionCommand();
		System.out.println("Vous avez appuy� sur " +cmd);
		...
		// L'utilisateur choisi l'endoit o� il enregistre le projet
	    ...
	    // Cr�ation du PDF
			      ...
			      try {
					PdfWriter.getInstance(document,new FileOutputStream(chemin_fichier_enregistrer+".pdf"));
				      ...
				      document.add(new Paragraph("Le cryptage utilis� est de type "+choixcryptage+"\n\n"));
				      document.add(new Paragraph("La clef utilis�e est :\n"));
				      ...
				      document.add(new Paragraph("\nLe message crypt� est :\n"));
				      document.add(new Paragraph(texte_message_crypte.getText()));
				      document.add(new Paragraph("\n\n\nL'application \"Safe for all v1.0\" cr��e par Quentin Comte-Gaz se trouve � l'adresse :"));
				      ...
				      document.close();
				      JOptionPane.showMessageDialog(null,"Votre fichier PDF a bien �t� export� � l'adresse "+chemin_fichier_enregistrer+".pdf", "Fichier PDF export�", JOptionPane.INFORMATION_MESSAGE);
				} catch (DocumentException | IOException e1) {
						JOptionPane.showMessageDialog(null,"Votre fichier PDF n'a pas pu etre cr�� pour une raison inconnue.", "Fichier PDF non export�", JOptionPane.INFORMATION_MESSAGE);

				}

			}
			else {
				//JOptionPane.showMessageDialog(null,"Vous n'avez pas selectionn� l'adresse du fichier, il se trouvera donc � l'endoit o� se trouve l'application.", "Fichier PDF non export�", JOptionPane.INFORMATION_MESSAGE);
			}
			...
			if(cmd.equals(APROPOS)) JOptionPane.showMessageDialog(null,"<html>Logiciel : Safe for all<br />Version : 1.0<br />� Tous droits r�serv�s 2012-2013<br /><br />Auteur : Quentin Comte-Gaz<br />Contact : Quentincg@free.fr<br />Site de l'�diteur : http://quentincg.free.fr/</html>" , APROPOS, JOptionPane.INFORMATION_MESSAGE, img);
			else JOptionPane.showMessageDialog(null,"Aide compl�te en ligne � l'adresse :\nhttp://quentincg.free.fr/safeforall/" , AIDE, JOptionPane.INFORMATION_MESSAGE, img);
			...
			else System.out.println("Vous n'avez pas selectionn� de fichier !");
		}
			...
			else System.out.println("VVous n'avez pas selectionn� de fichier !");
		}
			...
			else System.out.println("Vous n'avez pas selectionn� l'adresse du fichier !");
		}
			...
			choixcryptage=cmd;	// On choisit le type de cryptage en fonction du bouton appuy�
			supertitre.setText("Cryptage de type "+choixcryptage);
			System.out.println("Notre nouveau cryptage est : "+choixcryptage);

			if(cmd.equals(BOUTTON_AES)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre constitu�e de 16 caract�res ASCII<br/> - Le message n'a pas de restriction particuli�re</html>");
			if(cmd.equals(BOUTTON_DES)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre constitu�e de 7 caract�res ASCII<br/> - Le message n'a pas de restriction particuli�re</html>");
			if(cmd.equals(BOUTTON_VIGENERE)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre constitu�e uniquement de lettres<br/> - Seul les lettres du message seront crypt�es, les autres caract�res (0->9,&�\"...) seront donc effac�s, de plus, les lettres en minuscules seront transform�es en majuscules</html>");
			if(cmd.equals(BOUTTON_VIGENERE_AMELIORE)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre constitu�e uniquement de lettres<br/> - Seul les lettres du message seront crypt�es, les autres caract�res (0->9,&�\"...) ne seront pas crypt�s mais seront toujours pr�sents</html>");
			if(cmd.equals(BOUTTON_CESAR_AMELIORE)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre un entier compris entre 0 et 224<br/> - Le message n'a pas de restriction particuli�re</html>");
			if(cmd.equals(BOUTTON_CESAR_CLASSIQUE)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef de cryptage doit �tre un entier compris entre 0 et 26<br/> - Seul les lettres du message seront crypt�es, les autres caract�res ne seront cependant pas effac�s</html>");
			if(cmd.equals(BOUTTON_RSA)) supertitre2.setText("<html>Conditions d'utilisation :<br/> - La clef priv�e et publique vous sont fournit par defaut<br/> - Le message n'a pas de restriction particuli�re</html>");
		...
		if(cmd.equals(BOUTTON_LANCER_CRYPTAGE)){
			...
			System.out.println("Debut du cryptage type "+choixcryptage+" en utilisant la clef \""+maclef+"\" et le message � crypter \""+messageacrypter+"\"");
			...
			if(choixcryptage==BOUTTON_AES)
			{
				if(maclef.length()==16){
					...
					JOptionPane.showMessageDialog(null,"Le cryptage est de type AES 128 bits.\nVotre clef de cryptage doit donc contenir 16 caract�res ASCII." , AIDE, JOptionPane.ERROR_MESSAGE);
			...
			if(maclef.length()==7){
				try {
				 ...
				 JOptionPane.showMessageDialog(null,"Le cryptage est de type DES 56 bits.\nVotre clef de cryptage doit donc contenir 7 caract�res ASCII." , AIDE, JOptionPane.ERROR_MESSAGE);
			}
		...
		if(cmd.equals(CHERCHER_CLEF)){
			if(choixcryptage==BOUTTON_CESAR_CLASSIQUE){
				...
				if((texte_message_crypte.getText()).length()>25) JOptionPane.showMessageDialog(null,"Clef la plus probable : "+attaqueclef.cleflaplusprobable+"\nTexte d�chiffr� associ� : "+cesar.dechiffrer(attaqueclef.cleflaplusprobable).substring(0,25)+"\n\n2�me clef la plus probable : "+attaqueclef.deuxiemecleflaplusprobable+"\nTexte d�chiffr� associ� : : "+cesar.dechiffrer(attaqueclef.deuxiemecleflaplusprobable).substring(0,25)+"\n\n3�me clef la plus probable : "+(attaqueclef.cleflaplusprobable-32)+"\nTexte d�chiffr� associ� : "+cesar.dechiffrer(attaqueclef.cleflaplusprobable-32).substring(0,25)+"\n\n4�me clef la plus probable : "+(attaqueclef.deuxiemecleflaplusprobable-32)+"\nTexte d�chiffr� associ� : "+cesar.dechiffrer(attaqueclef.deuxiemecleflaplusprobable-32).substring(0,25)+"\n\nForce brute :\n"+sb, "Recherche de la clef de cryptage", JOptionPane.INFORMATION_MESSAGE);
				else JOptionPane.showMessageDialog(null,"Votre message est bien trop court pour une analyse fr�quentielle.\n\nForce brute :\n"+sb, "Recherche de la clef de cryptage", JOptionPane.INFORMATION_MESSAGE);
			}
				...
				if((texte_message_crypte.getText()).length()>100) JOptionPane.showMessageDialog(null,"Taille de la clef : "+attaqueclef.tailleclef+"\nLa fonction de cryptanalyse n'est pas termin� et ne permet donc pas de retrouver le message complet","Recherche de la clef de cryptage", JOptionPane.INFORMATION_MESSAGE);
				else JOptionPane.showMessageDialog(null,"Votre message crypt� est bien trop court pour une analyse Kasiski (il faut au minimum 100 caract�res)", "Recherche de la clef de cryptage", JOptionPane.INFORMATION_MESSAGE);
			}

			else if(choixcryptage==BOUTTON_VIGENERE_AMELIORE){
				 JOptionPane.showMessageDialog(null,"Cete fonction n'a pas encore �t� cod�","Recherche de la clef de cryptage",JOptionPane.INFORMATION_MESSAGE);
			}
		...
		if(cmd.equals(BOUTTON_LANCER_DECRYPTAGE)){
			System.out.println("Debut du d�cryptage "+choixcryptage);
			String messageadecrypter = texte_message_crypte.getText();
			String maclef2 = texte_clef.getText();
			System.out.println("Debut du d�cryptage type "+choixcryptage+" en utilisant la clef \""+maclef2+"\" et le message crypt� \""+messageadecrypter+"\"");
			...
			if(choixcryptage==BOUTTON_AES)
			{
				if(maclef2.length()>=16){
					...
					messagedechiffe5 = new String(aes2.dechiffrerMess(b2));//D�chiffrement du message chiffr�
					texte_message_decrypte.setText(messagedechiffe5);
					System.out.println("Message d�chiffr� :\n"+messagedechiffe5);
				}
				else {
					 JOptionPane.showMessageDialog(null,"Le cryptage est de type AES 128 bits.\nVotre clef de cryptage doit donc contenir au minimum 16 caract�res." , AIDE, JOptionPane.ERROR_MESSAGE);
				}
			}else if(choixcryptage==BOUTTON_CESAR_AMELIORE){
				try{
					...
					System.out.println("Message d�chiffr� :  "+messageadecrypter7+"\n");
				...
				try{
					...
					System.out.println("Message d�chiffr� :  "+messageadecrypter9+"\n");
				...
				if(maclef2.length()==7){
					try {
						...
						// TODO Auto-generated catch block
						e1.printStackTrace();
						JOptionPane.showMessageDialog(null,"Impossible de d�crypter.\nErreur inconnu\nAvez vous bien mis le bon message crypt� ?." , AIDE, JOptionPane.ERROR_MESSAGE);
...
//Les m�thodes de la souris :
	...
	public void mouseClicked(MouseEvent e){
		...
		System.out.println("j'ai appuy�\n");
	}

	public void mouseReleased(MouseEvent e){
		//System.out.println("j'ai relach�\n");
	}

	public void mouseEntered(MouseEvent e) {
		//System.out.println("Je suis all� sur un �l�ment\n");
	}

	public void mouseExited(MouseEvent e) {
		//System.out.println("Je suis parti d'un �l�ment\n");
	}

	public void mouseDragged(MouseEvent e) {
		//System.out.println("J'ai appuy� et boug�\n");
	}
	public void mousePressed(MouseEvent e){
		//System.out.println("J'ai appuy� et je le suis encore \n");
	}
